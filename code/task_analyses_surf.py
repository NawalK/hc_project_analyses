...
class TaskAnalysis:
    ...
    def __init__(self, main_dir, movements):
        ...
        # Load surfaces       
        self.inflated = '/media/miplab-nas2/Data3/BMPD/hc_project/templates/surf/lh.inflated'
        self.sulc = '/media/miplab-nas2/Data3/BMPD/hc_project/templates/surf/lh.sulc'
        self.pial = '/media/miplab-nas2/Data3/BMPD/hc_project/templates/surf/lh.pial'
        self.smc_mask = surface.vol_to_surf('/media/miplab-nas2/Data3/BMPD/hc_project/analysis/masks/brain/iCAPs_z_SMC_bin.nii.gz', self.pial, radius=0,interpolation='nearest', kind='auto', n_samples=10, mask_img=None, depth=None) 
