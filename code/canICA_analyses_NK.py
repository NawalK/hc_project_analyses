...
class ICA:
    ...
    def get_ICA(self,components_,k=None):
        ...
        if k == None:
            results = (fastica(components_, whiten='arbitrary-variance', fun='cube',random_state=seed)
            for seed in seeds)
        
        else :
            results = (fastica(components_,n_components=k,whiten='arbitrary-variance', fun='cube',random_state=seed)
                       for seed in seeds)
