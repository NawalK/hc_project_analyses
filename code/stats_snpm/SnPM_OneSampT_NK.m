...
%% 
function SnPM_OneSampT_NK=SnPM_OneSampT_NK(permutation,t_thr,input_dir,tag_file,mask_filename,output_dir,output_filename)

%______________________________________________________________________
%% Initialization 
%______________________________________________________________________
SPM_Dir='/home/kinany/Code/iCAPs_latest/packages/spm12/'
addpath(SPM_Dir); % Add SPM12 to the path

permutation
files=spm_select('ExtFPList',fullfile(input_dir),[tag_file,'.*s_z.nii$']);
...
matlabbatch{1}.spm.tools.snpm.des.OneSampT.nPerm = 10;
